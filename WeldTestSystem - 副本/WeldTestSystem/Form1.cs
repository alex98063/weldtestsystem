...
namespace WeldTestSystem
{
    public partial class Form1 : Form
    {
        ...
        private void upmove()
        {
            ...
            Int32 step = Convert.ToInt32(textBoxup.Text) * 16556;
        ...
        {
            Int32 step = Convert.ToInt32(textBoxforward.Text) * 10347;
        ...
        private void backwardmove()
        {
            ...
            Int32 step = Convert.ToInt32(textBoxback.Text) * 10347;
            String str = "2lr-" + step.ToString() ;
            ComSend(str);
            ComSend("2sp200");
            ComSend("2m");
        ...
        {
            Int32 step = Convert.ToInt32(textBoxdown.Text) * 16556;
            String str = "3lr-" + step.ToString();
            ComSend(str);
            ComSend("3sp200");
            ComSend("3m");
        ...
        {
            Int32 step = Convert.ToInt32(textBoxleft.Text) * 8278;
        ...
        {
            Int32 step = Convert.ToInt32(textBoxright.Text) * 8278;
            String str = "1lr" + step.ToString();
            ComSend(str);
            ComSend("1sp200");
            ComSend("1m");
        ...
        {
            Int32 step = Convert.ToInt32(textBoxclock.Text) * 112;
        ...
        private void counterclock()
        {
            ...
            Int32 step = Convert.ToInt32(textBoxcounterclock.Text) * 112;
            String str = "4LR-" + step.ToString();
            ComSend(str);
            ComSend("4sp200");
            ComSend("4m");
        ...
        private void comboBox4_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            dianjinr = comboBox4.SelectedItem.ToString();
